namespace ModiBuff.Core
{
	public sealed class ActerAddDamageEffect : IStackEffect, IStateReset, IRevertEffect, IEffect
	{
		...
		public ActerAddDamageEffect(float damage, bool revertible = false, StackEffectType stackEffect = StackEffectType.None)
		{
			_damage = damage;
		...
		public void Effect(IUnit target, IUnit acter)
		{
			...
			acter.AddDamage(_damage + _extraDamage);
		}

		public void RevertEffect(IUnit target, IUnit acter)
		{
			acter.AddDamage(-_totalAddedDamage);
		}
